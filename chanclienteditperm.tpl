<div class="panel-body">
    <div class="col-sm-12 col-md-6">
        <h3>{$lang['chosechanclient']}</h3>
        <form class="form-horizontal" method="post" action="index.php?site=chanclienteditperm&amp;sid={$sid}">
            <div class="form-group">
                <label class="label-control col-sm-2" for="cid">{$lang['channelid']}</label>
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="cid"/>
                </div>
            </div>
            <div class="form-group">
                <label class="label-control col-sm-2" for="cldbid">{$lang['clientdbid']}</label>
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="cldbid"/>
                </div>
            </div>
            <button class="btn btn-success btn-block" type="submit" name="showperms">{$lang['view']}</button>
        </form>
    </div>
    {if isset($smarty.post.cid) AND isset($smarty.post.cldbid)}
    <div class="col-sm-12 col-md-6">
        <h3>{$lang['filter']}</h3>
        <form class="form-inline" method="post" action="index.php?site=chanclienteditperm&amp;sid={$sid}">
            <input type="hidden" name="cid" value="{$smarty.post.cid}" />
            <input type="hidden" name="cldbid" value="{$smarty.post.cldbid}" />
            <input class="form-control" type="text" name="searchperms"/>
            <button class="btn btn-success" type="submit" name="search">{$lang['search']}</button>
        </form>
...
{if isset($smarty.post.cid) AND isset($smarty.post.cldbid)}
    <h4>({$smarty.post.cid}) {$channelname} ({$smarty.post.cldbid}) {$clientname} {$lang['permissionlist']}</h4>
    <form method="post" action="index.php?site=chanclienteditperm&amp;sid={$sid}">
        <table class="table table-condensed table-hover table-striped panel-body">
            <thead>
                <tr>
                    <th><a href="javascript:Klappen(0)"><img src="gfx/images/{$disp_pic}.png" id="Pic0" name="{$disp_pic}" border="0" alt="aus/ein-klappen" /></a></th>
                    <th>{$lang['permid']}</th>
                    <th>{$lang['permname']}</th>
                    <th>{$lang['value']}</th>
                    <th>{$lang['options']}</th>
                    <th>{$lang['grant']} <input type="text" name="granttoall" size="3" maxlength="3" /></th>
                </tr>
            </thead>
        ...
        <div class="col-sm-12">
            ...
            <button class="btn btn-success btn-block" type="submit" name="editall"><i class="fa fa-lg fa-edit"></i>&nbsp;{$lang['edit']}</button>
        </div>
    </form>
{/if}